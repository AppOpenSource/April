...
public class DBUtils {
    ...
    private DBUtils(Context context) {
        mSQLiteDatabase = new DBHelper(context, GlobalConstant.DB__IS_READ_NAME + ".db").getWritableDatabase();
    }
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
           ...
           // db.execSQL("create table if not exists " + Config.VIDEO + "(id integer primary key autoincrement,key text unique,is_read integer)");
            ...
            db.execSQL("create table if not exists " + GlobalConstant.WEIXIN + "(id integer primary key autoincrement,key text unique,is_read integer)");
        }
