package com.point.april.common.location;
...
import com.point.april.common.location.listener.GPSLocationListener;
import com.point.april.common.location.listener.NetworkLocationListener;
...
public class LocationUtil {
    ...
    public boolean signIn(Context context) {
        ...
        // PEOPLE
        long userId = 10001;
        String userName = PreferencesUtil.getString(mContext, GlobalConstant.SHARE_VALUE_USER_NAME);
        String nickName = PreferencesUtil.getString(mContext, GlobalConstant.SHARE_VALUE_NICK_NAME);
