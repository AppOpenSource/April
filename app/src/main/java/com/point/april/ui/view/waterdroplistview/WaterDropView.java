package com.point.april.ui.view.waterdroplistview;
...
import com.point.april.bean.Circle;
import com.point.april.util.Utils;
...
//        canvas.drawBitmap(arrowBitmap, topCircle.getX() - topCircle.getRadius(), topCircle.getY() - topCircle.getRadius(), mPaint);
    ...
    public void updateComleteState(float percent) {
        if (percent < 0 || percent > 1) {
            // TODO throw new IllegalStateException("completion percent should between 0 and 1!");
        }
